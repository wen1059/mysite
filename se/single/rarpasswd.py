...
def get_pwd(file_path, output_path, pwd):
    ...
    # 输出解压后的文件路径
    # out_put_file_path = r'C:\Users\Administrator\Downloads\{}'.format(file.namelist()[0])
...
file_path = r'C:\Users\Administrator\Downloads\Python极客项目编程  Mahesh Venkitachalam完整版.rar'
